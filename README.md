...
python pifs.py --structList pifs_testInput --inDir pdb --networkOutDir out --popscompOutDir out --popsDir ~/pops --popscompDir ~/POPSCOMP --errorFile out/out.err
```
...
```
# example usage; please change --popsDir and --popscompDir as appropriate (see below description)
python pifs_SeqRegion.py --structList pifsRegion_testInput --inDir pdb --networkOutDir out --errorFile out/out.err
```
